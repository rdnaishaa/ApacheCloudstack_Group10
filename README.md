...
---
# Konfigurasi Host/Hypervisor

Langkah terakhir adalah menyiapkan sisi host atau hypervisor yang akan dikelola oleh CloudStack:

1. Melakukan pembaruan sistem (update) dan pastikan Tailscale juga aktif di sisi host.
```bash
sudo apt update && sudo apt upgrade -y
```
